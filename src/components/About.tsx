...
const About = () => {
  const skills = [
    ...
    { icon: Code, name: "Design", description: "Web & App Interface" },
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-heading font-bold text-center mb-4 animate-fade-in-up opacity-0" style={{ animationDelay: "0.1s", animationFillMode: "forwards" }}>
            <span className="text-glow-cyan text-primary">Tentang</span> <span className="text-glow-purple text-secondary">Saya</span>
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center animate-slide-in-left opacity-0" style={{ animationDelay: "0.3s", animationFillMode: "forwards" }}>
              <div className="relative group">
                ...
                <img src={profileImg} alt="Profile" className="relative rounded-full w-64 h-64 md:w-80 md:h-80 object-cover border-4 border-primary/50" />
              </div>
            </div>
            ...
            <div className="space-y-6 animate-slide-in-right opacity-0" style={{ animationDelay: "0.4s", animationFillMode: "forwards" }}>
              <div className="space-y-4">
                <p className="text-lg leading-relaxed text-muted-foreground animate-fade-in-up opacity-0" style={{ animationDelay: "0.5s", animationFillMode: "forwards" }}>
                  Halo! Saya Nihlah Auliya mahasiswa Teknik Informatika STMIK IKMI Cirebon angkatan tahun 2025. Saya desainer grafis dan junior dev yang passionate dalam menciptakan visual estetik dengan sentuhan futuristik. Dengan
                  pengalaman di berbagai projek desain dan kerajinan buqet custom, saya siap mewujudkan ide kreatif Anda.
                </p>
