...
const Services = () => {
  const designServices = ["Logo & Brand Identity", "Social Media Content", "Banner & Poster Design", "UI/UX Design", "Custom Illustration", "CV & Portfolio Design"];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-heading font-bold text-center mb-4 animate-fade-in-up opacity-0" style={{ animationDelay: "0.1s", animationFillMode: "forwards" }}>
            <span className="text-glow-cyan text-primary">Jasa</span> <span className="text-glow-purple text-secondary">& Produk</span>
          </h2>
            ...
            <div className="bg-card border-2 border-primary/20 rounded-lg p-8 hover:border-primary transition-all duration-300 hover:box-glow-cyan">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center justify-between pt-4 border-t border-primary/20">
                <div className="text-center sm:text-left">
                  ...
                  <p className="text-2xl font-bold text-primary text-glow-cyan">Rp 15.000</p>
                </div>
                <Button onClick={() => handleWhatsApp("Jasa Desain Grafis")} className="bg-primary text-primary-foreground hover:bg-primary/90 box-glow-cyan hover:scale-105 transition-all duration-300">
                  Pesan Sekarang
                </Button>
              </div>
            </div>
          ...
          {/* Bouquet Products */}
          <div
            className="bg-card border-2 border-secondary/20 rounded-lg p-8 hover:border-secondary transition-all duration-300 hover:box-glow-purple animate-slide-in-right opacity-0"
          ...
          >
              ...
              {bouquetTypes.map((bouquet, index) => (
                ...
                >
                  <div className="aspect-video overflow-hidden">
                    <img src={bouquet.image} alt={bouquet.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                  </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between pt-4 border-t border-secondary/20">
              <div className="text-center sm:text-left">
                <p className="text-sm text-muted-foreground mb-1">Harga mulai dari</p>
                <p className="text-2xl font-bold text-secondary text-glow-purple">Rp 13.000</p>
              </div>
              <Button onClick={() => handleWhatsApp("Produk Buqet Custom")} className="bg-secondary text-secondary-foreground hover:bg-secondary/90 box-glow-purple hover:scale-105 transition-all duration-300">
                Pesan Sekarang
              </Button>
            </div>
          </div>
